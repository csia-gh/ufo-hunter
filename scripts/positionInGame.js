...
class InGamePosition {
    ...
    draw(play) {
        ...
        ctx.textAlign = "left";
        ctx.fillText("Nyomd meg S-t ha le akarod venni a hangot. :", play.playBoundaries.left, play.playBoundaries.bottom + 70);
        let soundStatus = (play.sounds.muted === true) ? "Ki" : "Be";
        ...
        ctx.fillStyle = '#424242';
        ctx.textAlign = "right";
        ctx.fillText("Nyomj P-t a jatek szuneteltesehez.", play.playBoundaries.right, play.playBoundaries.bottom + 70);
        // draw Score & Level
        ctx.textAlign = "center";
        ctx.fillStyle = '#BDBDBD';
        ctx.font = "bold 24px Comic Sans MS";
        ctx.fillText("Pontok", play.playBoundaries.right, play.playBoundaries.top - 75);
        ctx.font = "bold 30px Comic Sans MS";
        ctx.fillText(play.score, play.playBoundaries.right, play.playBoundaries.top - 25);
        ctx.font = "bold 24px Comic Sans MS";
        ctx.fillText("Szint", play.playBoundaries.left, play.playBoundaries.top - 75);
        ctx.font = "bold 30px Comic Sans MS";
        ...
        if (play.shields > 0) {
            ctx.fillStyle = '#BDBDBD';
            ctx.font = "bold 24px Comic Sans MS";
            ctx.fillText("Pajzsok", play.width / 2, play.playBoundaries.top - 75);
            ctx.font = "bold 30px Comic Sans MS";
            ...
            ctx.font = "bold 24px Comic Sans MS";
            ctx.fillText("Figyelem", play.width / 2, play.playBoundaries.top - 75);
            ctx.fillStyle = '#BDBDBD';
            ctx.fillText("Nem maradt pajzsod!", play.width / 2, play.playBoundaries.top - 25);
        }
    }
